...
// SOS sepenuhnya — risiko yang tidak boleh ada pada fitur darurat.
...
export default async function handler(req, res) {
  ...
  const limits = { 'sos-create':40, 'sos-nearby':200, 'sos-resolve':60, 'sos-report':10, 'sos-instructions':5, admin:60, checkin:30, 'permit-verify':60 };
